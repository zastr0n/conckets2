...
<body class="bg-black"> 
    ...
    <div class="relative flex-col bg-clip-border rounded-xl bg-transparent text-gray-700 shadow-none grid gap-2 item sm:grid-cols-2">
      ...
      <div class="p-6 px-2 sm:pr-6 sm:pl-4">
        ...
        <div class="flex items-center gap-4"><img src="/images/soundwavelogo1.png" class="inline-block relative object-cover object-center !rounded-full w-12 h-12 " />
          <div>
            <p class="block antialiased font-sans text-base font-light leading-relaxed text-blue-gray-900 mb-0.5 ">Soundwave!</p>
