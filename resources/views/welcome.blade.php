...
<div
  class="h-full min-h-full bg-gradient-to-r from-cyan-500 to-blue-500 bg-center 2xl:min-h-full">
          ...
          <form [formGroup]="loginForm" (submit)="submit()">
            <div class="relative mt-9">
              <input
                ...
                class="flex w-full items-center gap-2 rounded-lg border border-zinc-300 px-4 py-2 lg:py-3" />
              <div class="absolute -top-4 left-3 bg-white px-1">
                <label class="text-xs text-zinc-500" for="email"
            ...
            <div class="relative mt-6">
              <input
                ...
                class="flex w-full items-center gap-2 rounded-lg border border-zinc-300 px-4 py-2 lg:py-3" />
              <div class="absolute -top-4 left-3 bg-white px-1">
                <label class="text-xs text-zinc-500" for="password"
                  >Password</label
                >
              </div>
            </div>
            <button
              ...
              [disabled]="loading"
              class="mt-5 w-full rounded-lg bg-cyan-500 py-2 font-semibold text-white duration-200 ease-in-out hover:bg-cyan-600">
              Masuk
            </button>
